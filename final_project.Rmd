...
# I then got rid of the na values in the Age data column and filtered for the winter season.

age_data <- athlete_events %>%
  na.omit(Age) %>%
  filter(Season == "Winter")

# I then took the data and made a series of if else statements and stored them all as the
...
# I then took the values for which gold cam up to store then as gold. I did the same for silver.
...
# I then added geom_density and made the inside of graph blue with a black border.
...
# age values on the y axis. I grouped by and colored medal so that each type of medal had there own
...
# I then made a variable that accounetd for each athlete once. I didnt want to double count
...
# I then sued [3:4] in order to change the 3rd element to Male and the 4th element to Female.
# I then got rid of the na values for Male and then Female in the nation_numbers data set and 
# replaced the with a 0.
...
# I then selected the variables that I wanted to us in my model.
...
# I saved the table as an html so that I would output the whole table in my shiny app.
